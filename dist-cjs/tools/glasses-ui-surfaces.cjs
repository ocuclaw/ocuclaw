...
const RENDER_DROP_CODES = Object.freeze(["session_mismatch"]);
...
function normalizeGlassesSessionKey(key) {
  return typeof key === "string" ? key.replace(/^agent:[^:]+:/, "") : key;
}

function createSurfaceStore(deps = {}) {
